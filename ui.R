...
sidebar <- dashboardSidebar(
    width = 150,
    sidebarMenu(
        menuItem(tagList(icon("tachometer-alt", verify_fa = FALSE)," Dashboard"), tabName = "home"),
        ...
        menuItem(tagList(icon("boxes", verify_fa = FALSE)," Univariate Plots"), tabName = "univariate"),
